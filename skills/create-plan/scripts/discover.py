...
Examples:
  python scripts/discover.py --files "src/**/*.ts" --names "parseConfig,UserService"
  python scripts/discover.py --names "/^use[A-Z]/" --ext ts,tsx
  python scripts/discover.py --files "plan/**/*.md" --json
