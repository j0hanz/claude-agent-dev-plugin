...
Detailed per-task-type breakdown. For the quick formula, see the [Effort Estimation](#effort-estimation) section above.
...
**Simple feature (add validation)**: 1 file 30 LOC + 8 tests = **~45 min**

**Medium feature (JWT auth)**: 2 files 200 LOC + 30 tests + config + docs = **~3 hours**

**Large feature (multi-service API gateway)**: 5 files 500 LOC + 80 tests + 2 configs + docs + 5-repo discovery = **~7-8 hours**
