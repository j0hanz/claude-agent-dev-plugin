...
!(function (t, e) {
  ...
  class St extends B {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? P.one(this._element, mt, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  function ve(t) {
    return (
      'undefined' != typeof ShadowRoot && (t instanceof ge(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  const ye = {
    name: 'applyStyles',
        ...
        (('body' !== me(e) || Ze(a)) &&
          (c =
            (n = e) !== ge(n) && be(n)
              ...
              : Ge(n)),
        be(e) ? (((h = xe(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = Je(a))),
      {
  ...
  class Zi extends W {
    ...
    dispose() {
      this._isAppended &&
        (P.off(this._element, Ui), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class ps extends B {
    ...
    show() {
      ...
      const t = P.trigger(this._element, this.constructor.eventName('show')),
        e = (h(this._element) || this._element.ownerDocument.documentElement).contains(
          this._element,
        );
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove(ss), 'ontouchstart' in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) P.off(t, 'mouseover', d);
        ...
        if ('click' === e)
          ...
          (P.on(this._element, t, this._config.selector, (t) => {
            ...
            P.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              ((e._activeTrigger['focusout' === t.type ? cs : ls] = e._element.contains(
                t.relatedTarget,
              )),
                e._leave());
            }));
