...
When dispatching the `researcher` subagent (`agents/researcher.md`) for the audit step (SKILL.md PATH A step 5), instruct it to produce JSON output with the following structure:
